...
function linkContainer(id) {
	var urlToUse = $("div#"+id+" > a[href]").attr("href");
	$("div#banner div.bannerCover").attr("href", urlToUse);
	
	$("div#banner div.bannerCover[href]").click(function() {
		var sendRequest = $(this).attr("href");
		document.location.href=''+sendRequest+'';
	});
};
