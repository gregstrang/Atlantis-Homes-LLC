...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>">
	<head>
        ...
        <?php print $head ?>
        <meta name="google-site-verification" content="SwwMBaQIYlyj8TZ2E6LSHCzqKakP42SWQVJbfsmKRLs" />
        <?php print $styles ?>
        <?php print $scripts ?>
        ...
        <div id="wrapper">
            ...
            <div id="container">
                ...
                <div id="containerContent">
                    ...
                    <?php if ($right): ?>
                      <div id="sidebar-right<?php if(arg(1) == 2): ?>-homepage<?php endif; ?>" class="sidebar">
                        <?php print $right ?>
                      </div> <!-- /#sidebar-right -->
                    <?php endif; ?>
